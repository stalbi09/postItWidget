...
class PostItView extends WidgetView {
	...
	draw() {
		...
		SS.style(this.try.text, {"position": "absolute","top":"125px","left" : "5px", "width": "280px", "height": "100px", "backgroundColor": "rgba(255, 246, 143, 1)"
, "overflow": "hidden"});
		...
		SS.style(this.try.ajout, {"userSelect": "none", "cursor": "pointer","position": "absolute","top":"50px","left" : "20px"});
